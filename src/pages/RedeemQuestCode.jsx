...
export default function RedeemQuestCode() {
  ...
  if (result?.success) return <div className="mx-auto max-w-xl p-4 sm:p-8"><div className="rounded-xl border border-green-200 bg-green-50 p-8 text-center"><div className="text-5xl">✅</div><h1 className="mt-3 text-2xl font-bold">Доступ выдан</h1><p className="mt-3 text-gray-700">Квест добавлен выбранному участнику.</p><Link to={`/play/${result.quest_id}?participant=${encodeURIComponent(participantProfileId)}`} className="mt-6 inline-block rounded-lg bg-blue-600 px-5 py-3 text-white">Открыть квест</Link></div></div>
